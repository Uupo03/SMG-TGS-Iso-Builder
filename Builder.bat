...
echo \======================================================/
SET /P moddedFile=Please enter a name. (e.g. SMG, The Green Stars.iso, SMG or The Green Stars.wbfs): 
...
echo \==================================/
SET /P  newGameID=Please enter the new Game ID (e.g. RMGE02 or STGS01): 
...
echo \==============================/
SET /P  newTMD=Please enter the new TMD (e.g. RMGE or STGS): 
